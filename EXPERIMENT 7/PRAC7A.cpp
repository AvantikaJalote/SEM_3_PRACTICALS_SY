...
class Internal1
{
    ...
    void operator+(External1 &); //operator overloading of "+". Along with this, it's also a friend function
};
...
class External1
{
    ...
    friend void Internal1::operator+(External1 &); //operator overloaded friend function
};
...
void Internal1::operator+(External1 &marks) //operator overloaded friend function
{
